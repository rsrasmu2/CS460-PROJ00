...
public class WebServer
{
	public static void main(String args[]) throws IOException
	{
        ...
        //An infinite while loop to create an "aways-on" server
		while (true) 
        {
            //connect to client socket
            Socket socket = serverSocket.accept();
            //This sends output from the server socket to the client socket. This is like a channel to "talk" the cleint
            PrintWriter out = new PrintWriter(socket.getOutputStream(), true);
            //This receives an input from the the client. This is like a channel that "listens" to the client
